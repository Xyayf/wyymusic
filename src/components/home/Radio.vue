<template>
  <div class="Radio">
      ...
      <div class="dttab">
        <ul>
          ...
          <router-link to="/hotRadio">
            <li>
              <div class="dtimg">
                <img src="../../assets/img/dj2.png" alt="" />
              </div>
              <div class="dttit">
          ...
          <router-link to="/payBoutique">
            <li>
              <div class="dtimg">
                <img src="../../assets/img/dj3.png" alt="" />
              </div>
              <div class="dttit">
          ...
          <li>
            <router-link to="#">
              <div class="dtimg">
                <img src="../../assets/img/dj4.png" alt="" />
              </div>
              <div class="dttit">
    ...
    <div class="listdata" style="height: 703px">
      <ul>
        <li
          v-for="(item, index) in getrecommendData"
          :key="item.id"
          @click="openDafreemname(item.id)"
        >
          <div class="pic">
