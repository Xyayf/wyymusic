<template>
  <div class="Radio_detail">
    <div class="topBack" id="topBack">
      <div class="topbox">
        <div class="topBackpic" @click="onClickLeft">
      ...
      <van-tabs v-model="active">
        ...
        <van-tab title="节目">
          ...
          <div class="list">
            <ul>
              <li
                v-for="(item, index) in jielist"
                :key="index"
                @click="playMusic(item.id, item.name, item.blurCoverUrl)"
              >
                <div class="musicbg">
  ...
  methods: {
    getDeatil () {
      ...
      this.$axios({
        method: 'get',
        dataType: 'json',
        url: Config.api.getDetailradio + this.$route.query.radio,
      }).then(res => {
    ...
    getprogram () {
      ...
      this.$axios({
        method: 'get',
        dataType: 'json',
        url: Config.api.getprogram + this.$route.query.radio + "&cookie=" + this.$store.state.userinfo.cookie,
      }).then(res => {
